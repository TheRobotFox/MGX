...
int** var
MGX_T_VAR(PTR(PTR(int)), var)
MGX_T_PTR(PTR(PTR(int)))

int (*var)[3][2][1]
MGX_T_VAR(PTR(ARRAY(ARRAY(ARRAY(int, 1),2),3)), var)
MGX_T_PTR(PTR(ARRAY(ARRAY(ARRAY(int, 1),2),3)))

int (**var)[3][2][1]
MGX_T_VAR(PTR(PTR(ARRAY(ARRAY(ARRAY(int, 1),2),3))), var)
MGX_T_PTR(PTR(PTR(ARRAY(ARRAY(ARRAY(int, 1),2),3))))

int *var[3][2][1]
MGX_T_VAR(ARRAY(ARRAY(ARRAY(PTR(int), 1),2),3), var)
MGX_T_PTR(ARRAY(ARRAY(ARRAY(PTR(int), 1),2),3))

int (*var[3][2])[1]
MGX_T_VAR(ARRAY(ARRAY(PTR(ARRAY(int, 1)),2),3), var)
MGX_T_PTR(ARRAY(ARRAY(PTR(ARRAY(int, 1)),2),3))

int (*var[3])[2][1]
MGX_T_VAR(ARRAY(PTR(ARRAY(ARRAY(int, 1),2)),3), var)
MGX_T_PTR(ARRAY(PTR(ARRAY(ARRAY(int, 1),2)),3))

int *(*var[3])[2][1]
MGX_T_VAR(ARRAY(PTR(ARRAY(ARRAY(PTR(int), 1),2)),3), var)
MGX_T_PTR(ARRAY(PTR(ARRAY(ARRAY(PTR(int), 1),2)),3))

int (*var[4][3][2])[1]
MGX_T_VAR(ARRAY(ARRAY(ARRAY(PTR(ARRAY(int, 1)),2),3),4), var)
MGX_T_PTR(ARRAY(ARRAY(ARRAY(PTR(ARRAY(int, 1)),2),3),4))

int (*var[5][4][3][2])[1]
MGX_T_VAR(ARRAY(ARRAY(ARRAY(ARRAY(PTR(ARRAY(int, 1)),2),3),4),5), var)
MGX_T_PTR(ARRAY(ARRAY(ARRAY(ARRAY(PTR(ARRAY(int, 1)),2),3),4),5))
